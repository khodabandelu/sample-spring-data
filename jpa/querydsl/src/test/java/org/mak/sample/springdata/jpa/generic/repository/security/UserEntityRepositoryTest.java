...
public class UserEntityRepositoryTest {
    ...
    public void testSaveUser() {
        ...
        User savedUser = userRepository.findOne(UserExpressionQueryDsl.UserIncludeUsername("mehdi")).orElse(null);
    ...
    public void testfindAllUser() {
        ...
        Assert.assertNotNull(userRepository.findAll(UserExpressionQueryDsl.UserIncludeUsername("i")));
    }
